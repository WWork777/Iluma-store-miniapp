        ...
        <>
            <footer>
                ...
                <div className='footer-bottom'>
                        ...
                        <p>Федеральный закон Российской Федерации от 23 февраля 2013 г. N 15-ФЗ "Об охране здоровья граждан от воздействия окружающего табачного дыма и последствий потребления табака" Просматривая сайт, вы подтверждаете свое совершеннолетие и даете согласие на просмотр фото сигар, сигарилл, хьюмидоров и аксессуаров к ним на основании Закона РФ "О ЗАЩИТЕ ПРАВ ПОТРЕБИТЕЛЕЙ" от 07.02.1992 N 2300-1</p>
                </div>
            </footer>
        </>
    )
